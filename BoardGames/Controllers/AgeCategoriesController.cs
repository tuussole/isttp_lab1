...
namespace BoardGames.Controllers
{
    public class AgeCategoriesController : Controller
    {
        ...
        public AgeCategoriesController(ApplicationContext context)
        {
            _context = context;
        }
        ...
        {
            if (id == null || _context.AgeCategory == null)
            {
                return NotFound();
            }
        ...
        {
            if (_context.AgeCategory == null)
            {
                return Problem("Entity set 'ApplicationContext.AgeCategory'  is null.");
            }
            var ageCategory = await _context.AgeCategory.FindAsync(id);
            if (ageCategory != null)
            {
